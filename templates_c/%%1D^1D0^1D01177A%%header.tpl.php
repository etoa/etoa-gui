<?php /* Smarty version 2.6.14, created on 2007-09-17 16:46:42
         compiled from designs/Classic/header.tpl */ ?>
	<table id="layoutbox" width="<?php echo $this->_tpl_vars['gameWidth']; ?>
%">
		<tr>
			<td id="minibar">				
			</td>
...
$this->_sections['id']['loop'] = is_array($_loop=$this->_tpl_vars['topNav']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
?>
				<?php echo '';  if ($this->_tpl_vars['topNav'][$this->_sections['id']['index']]['nw_js'] != ""):  echo '<a href="';  echo $this->_tpl_vars['topNav'][$this->_sections['id']['index']]['url'];  echo '" onclick="window.open(\'';  echo $this->_tpl_vars['topNav'][$this->_sections['id']['index']]['url'];  echo '\',\'Box\',\'';  echo $this->_tpl_vars['topNav'][$this->_sections['id']['index']]['nw_js'];  echo '\');return false;">';  echo $this->_tpl_vars['topNav'][$this->_sections['id']['index']]['name'];  echo '</a> |';  elseif ($this->_tpl_vars['topNav'][$this->_sections['id']['index']]['newwindow'] == true):  echo '<a href="';  echo $this->_tpl_vars['topNav'][$this->_sections['id']['index']]['url'];  echo '" onclick="window.open(\'';  echo $this->_tpl_vars['topNav'][$this->_sections['id']['index']]['url'];  echo '\');return false;">';  echo $this->_tpl_vars['topNav'][$this->_sections['id']['index']]['name'];  echo '</a> |';  else:  echo '<a href="';  echo $this->_tpl_vars['topNav'][$this->_sections['id']['index']]['url'];  echo '">';  echo $this->_tpl_vars['topNav'][$this->_sections['id']['index']]['name'];  echo '</a> |';  endif;  echo ''; ?>
