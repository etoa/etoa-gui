...
if (isset($_GET['id'])) {
    ...
    if ($missile !== null) {
        ...
        echo "<tr><td width=\"220\" class=\"tbltitle\"><img src=\"" . $missile->getImagePath('other') . "\" width=\"220\" height=\"220\" alt=\"Raketen\" /></td>";
    ...
    if (count($missiles) > 0) {
        ...
        foreach ($missiles as $missile) {
            echo "<tr><td class=\"tbldata\" style=\"width:40px;background:#000\">
                            ...
                            <img src=\"" . $missile->getImagePath('small') . "\" alt=\"Raketen\" width=\"40\" height=\"40\" border=\"0\"/></a></td>";
