    ...
    if ($building !== null) {
        ...
        echo "<tr>
            <th style=\"width:220px;background:#000;padding:0px;\" rowspan=\"2\">
                <img src=\"" . $building->getImagePath('other') . "\" style=\"width:220px;height:220px;background:#000;margin:0px;\" align=\"top\" alt=\"Bild " . $building->name . "\" />
            </th>
            <td colspan=\"2\">
            ...
            echo "<tr>
                <td style=\"width:40px;padding:0px;background:#000;vertical-align:middle;\">
                    <a href=\"?$link&amp;site=$site&id=" . $building->id . "\">
                        <img src=\"" . $building->getImagePath('small') . "\" align=\"top\" style=\"width:40px;height:40px;background:#000;margin:0px;\" alt=\"Bild " . $building->name . "\" border=\"0\"/></a></td>";
