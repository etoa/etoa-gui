...
echo "<div align=\"justify\">";
    ...
    Wird das Angebot nicht innerhalb von ".$config->getInt('market_response_time')." Tagen verkauft, so wird es automatisch gelöscht. Du erhälst dannach aber nur noch einen gewissen Prozentsatz zurück. Dieser Wert ist der gleiche, wie wenn du das Angebot manuell zurückziehst!
    </ul><br>";
    echo "
    <ul>
    ...
    Die eingestellten Angebote werden ausserdem nach ".$config->getInt('market_response_time')." Tagen automatisch gelöscht, wenn sie vorher nicht gekauft wurden (Auktionen ausgeschlossen)!<br><br><br>";
