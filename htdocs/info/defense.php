...
if (isset($_GET['id']) && intval($_GET['id']) > 0) {
    ...
    if (null !== $defense) {
        ...
        echo "<tr><td class=\"tbltitle\">" . ResIcons::METAL . "" . RES_METAL . "</td><td class=\"tbldata\">" . StringUtils::formatNumber($defense->costsMetal) . "</td></tr>";
        echo "<tr><td class=\"tbltitle\">" . ResIcons::CRYSTAL . "" . RES_CRYSTAL . "</td><td class=\"tbldata\">" . StringUtils::formatNumber($defense->costsCrystal) . "</td></tr>";
        echo "<tr><td class=\"tbltitle\">" . ResIcons::PLASTIC . "" . RES_PLASTIC . "</td><td class=\"tbldata\">" . StringUtils::formatNumber($defense->costsPlastic) . "</td></tr>";
        echo "<tr><td class=\"tbltitle\">" . ResIcons::FUEL . "" . RES_FUEL . "</td><td class=\"tbldata\">" . StringUtils::formatNumber($defense->costsFuel) . "</td></tr>";
        echo "<tr><td class=\"tbltitle\">" . ResIcons::FOOD . "" . RES_FOOD . "</td><td class=\"tbldata\">" . StringUtils::formatNumber($defense->costsFood) . "</td></tr>";
