...
__webpack_require__(/*! ./jquery.mapbox.js */ "./resources/js/jquery.mapbox.js");

$(function () {
  // Load tabs
  $(".tabs").tabs(); // Load datepicker
...
(function ($, window, document, undefined) {
  ...
  $.fn.mapbox = function (options, callback) {
    ...
    function _move(x, y, node) {
      ...
      if (mapWidth < nodeWidth) {
        limitX = mapWidth - nodeWidth;
      }

      if (mapHeight < nodeHeight) {
        limitY = mapHeight - nodeHeight;
      }
    ...
    var method = {
      ...
      back: function back(distance) {
        distance = distance || 1;

        _zoom.call(this, 0 - distance);
      },
      left: function left(amount) {
        amount = amount || 10;

        _move.call(this, 0 - amount, 0);
      },
      right: function right(amount) {
        amount = amount || 10;

        _move.call(this, amount, 0);
      },
      up: function up(amount) {
        amount = amount || 10;

        _move.call(this, 0, 0 - amount);
      },
      down: function down(amount) {
        amount = amount || 10;

        _move.call(this, 0, amount);
      },
      center: function center(coords) {
        coords = coords || {
    ...
    return this.each(function () {
      ...
      if (typeof command === "string") {
        ...
        $(this).find(".map-layer-mask").css({
          ...
          // Omg, horrible hack,
          opacity: "0",
          // but only way IE will not freak out when
        ...
        $(document).mousemove(function (e) {
          ...
          if (mapmove && options.pan) {
            ...
            if (mapWidth < layer.width()) {
              limitX = mapWidth - layer.width();
            }

            if (mapHeight < layer.height()) {
              limitY = mapHeight - layer.height();
            }
        ...
        if (options.mousewheel && typeof $.fn.mousewheel !== "undefined") {
          $(viewport).mousewheel(function (e, distance) {
            if (options.zoomToCursor) {
              ...
              var layer = $(this).find('.current-map-layer'),
                  positionTop = e.pageY - layer.offset().top,
                  // jQuery normalizes pageX and pageY for us.
            ...
            if (_zoom.call(this, distance) && options.zoomToCursor
            /* && distance > 0*/
            ) {
              ...
              var x = layer.width() * percentLeft,
                  y = layer.height() * percentTop; // And set position.
        ...
        var clickTimeoutId = setTimeout(function () {}, 0),
            clickDefault = true;
        ...
        if (options.doubleClickZoom || options.doubleClickZoomOut || options.doubleClickMove) {
          $(viewport).dblclick(function (e) {
            ...
            _zoom.call(this, distance); // Convert percentage to pixels on new layer.


            layer = $(this).find('.current-map-layer');
            var x = layer.width() * percentLeft,
                y = layer.height() * percentTop; // And center.

            method.center.call(this, {
              x: x,
              y: y
            });
            return false;
  ...
  $.fn.mapbox.options = {
    ...
    // Does map zoom?
    pan: true,
    // Does map move side to side and up to down?
    defaultLayer: 0,
    // Starting at 0, which layer shows up first
    layerSplit: 4,
    // How many times to split each layer as a zoom level
    mapContent: ".mapcontent",
    // The name of the class on the content inner layer
    defaultX: null,
    // Default positioning on X-axis
    defaultY: null,
    // Default positioning on Y-axis
    zoomToCursor: true,
    // If true, position on the map where the cursor is set will stay the same relative distance from the edge when zooming
    doubleClickZoom: false,
    // If true, double clicking zooms to mouse position
    clickZoom: false,
    // If true, clicking zooms to mouse position
    doubleClickZoomOut: false,
    // If true, double clicking zooms out to mouse position
    clickZoomOut: false,
    // If true, clicking zooms out to mouse position
    doubleClickMove: false,
    // If true, double clicking moves the map to the cursor position
    clickMove: false,
    // If true, clicking moves the map to the cursor position
    doubleClickDistance: 1,
    // Number of positions (determined by layerSplit) to move on a double-click zoom event
    clickDistance: 1,
    // Number of positions (determined by layerSplit) to move on a click zoom event
    beforeDragging: function beforeDragging(layer, xcoord, ycoord, viewport) {},
    // This callback happens before dragging of map starts
    afterDragging: function afterDragging(layer, xcoord, ycoord, viewport) {},
    // This callback happens at end of dragging, after map is released on "mouseup"
    beforeZoom: function beforeZoom(level, layer, xcoord, ycoord, viewport) {},
    // Callback before a zoom happens
    afterZoom: function afterZoom(level, layer, xcoord, ycoord, viewport) {},
    // Callback after zoom has completed
    afterLayerChange: function afterLayerChange(level, layer, xcoord, ycoord, viewport) {},
    // Callback after layer has been changed while zooming.
    mousewheel: false
    /* Requires mousewheel event plugin: http://plugins.jquery.com/project/mousewheel*/
...
/***/ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/jquery-ui-bundle/jquery-ui.css":
/*!***************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/jquery-ui-bundle/jquery-ui.css ***!
  \***************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_jquery_ui_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! !!../css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!../postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./jquery-ui.css */ "./node_modules/css-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[1]!./node_modules/postcss-loader/dist/cjs.js??ruleSet[1].rules[6].oneOf[1].use[2]!./node_modules/jquery-ui-bundle/jquery-ui.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_jquery_ui_css__WEBPACK_IMPORTED_MODULE_1__.default, options);



/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_1_postcss_loader_dist_cjs_js_ruleSet_1_rules_6_oneOf_1_use_2_jquery_ui_css__WEBPACK_IMPORTED_MODULE_1__.default.locals || {});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunketoa_gui"] = self["webpackChunketoa_gui"] || [];
