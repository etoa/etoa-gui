...
if (isset($_GET['user_id']) && $_GET['user_id'] > 0) {
    ...
    if ($user !== null) {
        ...
        echo "<b>Punkte aktuell:</b> " . StringUtils::formatNumber($user->points) . ", <b>Rang aktuell:</b> " . $user->rank . "<br/><br/>";
        ...
        if (count($pointEntries) > 0) {
            ...
            foreach ($pointEntries as $entry) {
                ...
                echo "<td class=\"tbldata\">" . StringUtils::formatNumber($entry->points) . "</td><td class=\"tbldata\">" . StringUtils::formatNumber($entry->shipPoints) . "</td><td class=\"tbldata\">" . StringUtils::formatNumber($entry->techPoints) . "</td><td class=\"tbldata\">" . StringUtils::formatNumber($entry->buildingPoints) . "</td></tr>";
            }
            echo "</table>";
        } else {
