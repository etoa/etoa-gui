...
if (isset($cp)) {
    ...
    if ($researchBuilding !== null && $researchBuilding->currentLevel > 0) {
        ...
        // Überschrift
        echo "<h1>Forschungslabor (Stufe " . $researchBuilding->currentLevel . ")" . (!empty($planet->name) ? " des Planeten " . $planet->name : "") . "</h1>";
        ...
        echo "<h1>Forschungslabor" . (!empty($planet->name) ? " des Planeten " . $planet->name : "") . "</h1>";
        echo $resourceBoxDrawer->getHTML($planet);
