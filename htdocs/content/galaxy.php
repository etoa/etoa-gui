...
echo '<tr><td id="galaxy_map_nav">Anzeigen: <select onchange="document.getElementById(\'img\').src=\'images/map\'+this.options[this.selectedIndex].value;">
...
echo '<tr><td id="galaxy_map_container"><img src="images/map?legend" alt="Galaxiekarte" id="img" alt="galaxymap" usemap="#Galaxy" style="border:none;"/></td></tr>';
tableEnd();
