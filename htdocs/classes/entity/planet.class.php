		...
		*/
		function resBox($small=0, $return=false)
		{
			...
			if ($small==0)
			{
				...
				<td class=\"$style0\" ".mTT(RES_METAL,"<img width=\"40px\" height=\"40px\" src=\"images/resources/metal.png\" style=\"float:left;margin-right:5px;\"/> <b>Vorhanden:</b> ".nf($this->resMetal)."<br/><b>Speicher:</b> ".nf($this->storeMetal)."<br style=\"clear:both;\"/>").">".nf(floor($this->resMetal))."</td>
				<td class=\"$style1\" ".mTT(RES_CRYSTAL,"<img width=\"40px\" height=\"40px\" src=\"images/resources/crystal.png\" style=\"float:left;margin-right:5px;\"/> <b>Vorhanden:</b> ".nf($this->resCrystal)."<br/><b>Speicher:</b> ".nf($this->storeCrystal)."<br style=\"clear:both;\"/>").">".nf(floor($this->resCrystal))."</td>
				<td class=\"$style2\" ".mTT(RES_PLASTIC,"<img width=\"40px\" height=\"40px\" src=\"images/resources/plastic.png\" style=\"float:left;margin-right:5px;\"/> <b>Vorhanden:</b> ".nf($this->resPlastic)."<br/><b>Speicher:</b> ".nf($this->storePlastic)."<br style=\"clear:both;\"/>").">".nf(floor($this->resPlastic))."</td>
				<td class=\"$style3\" ".mTT(RES_FUEL,"<img width=\"40px\" height=\"40px\" src=\"images/resources/fuel.png\" style=\"float:left;margin-right:5px;\"/> <b>Vorhanden:</b> ".nf($this->resFuel)."<br/><b>Speicher:</b> ".nf($this->storeFuel)."<br style=\"clear:both;\"/>").">".nf(floor($this->resFuel))."</td>
		...
		function reset()
		{
			dbquery("
				...
				SET
					...
					planet_prod_food=0,
					planet_prod_power=0,
					planet_bunker_metal=0,
					planet_bunker_crystal=0,
					planet_bunker_plastic=0,
					planet_bunker_fuel=0,
					planet_bunker_food=0,
