...
sudo apt-get install -q -y -f --no-install-recommends git mysql-server mysql-client nginx php8.5 php8.5-fpm php8.5-xdebug

# Install commonly used php packages
sudo apt-get install -q -y -f php8.5-curl php8.5-cli php8.5-mysql php8.5-gd php8.5-zip php8.5-mbstring php8.5-intl php8.5-redis php8.5-xml
