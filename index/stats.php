<?PHP
	...
	// 	Erstellt: 01.12.2004
	// 	Geänder von: Nicolas Perrenoud alias MrCage
	// 	Geänder am: 27.04.2007
	// 	Kommentar:
	//
	...
	if ($mode=="user")
		echo "<tr><td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=user\" class=\"tabEnabled\">Spieler</a></td>";
	else
		echo "<tr><td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=user\" class=\"tabDefault\">Spieler</a></td>";
	if ($mode=="ships")
		echo "<td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=ships\" class=\"tabEnabled\">Flotten</a></td>";
	else
		echo "<td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=ships\" class=\"tabDefault\">Flotten</a></td>";
	if ($mode=="tech")
		echo "<td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=tech\" class=\"tabEnabled\">Technologien</a></td>";
	else
		echo "<td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=tech\" class=\"tabDefault\">Technologien</a></td>";
	if ($mode=="buildings")
		echo "<td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=buildings\" class=\"tabEnabled\">Geb&auml;ude</a></td>";
	else
		echo "<td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=buildings\" class=\"tabDefault\">Geb&auml;ude</a></td>";
	if ($mode=="alliances")
		echo "<td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=alliances\" class=\"tabEnabled\">Allianzen</a></td></tr>";
	else
		echo "<td class=\"statsTab\" style=\"width:18%;\"><a href=\"?index=stats&amp;mode=alliances\" class=\"tabDefault\">Allianzen</a></td></tr>";
	echo "</table><br/>";
	...
	else
	{
		...
		echo "<form action=\"?index=stats&amp;mode=$mode\" method=\"post\"><table class=\"tbl\">";
