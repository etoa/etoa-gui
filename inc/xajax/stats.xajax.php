...
function statsShowBox($mode, $sort="", $sortOrder="")
{
  ...
  $objResponse = new xajaxResponse();
	...
	switch ($mode)
	{
		...
		case "ships":
			$objResponse->assign('tabMenu1', 'className', "tabEnabled"); break;
		case "tech":
			$objResponse->assign('tabMenu2', 'className', "tabEnabled"); break;
		case "buildings":
			$objResponse->assign('tabMenu3', 'className', "tabEnabled"); break;
		case "alliances":
