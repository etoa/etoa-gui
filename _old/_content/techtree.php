<?PHP
	...
	if ($planets->current)
	{
		...
		show_tab_menu("mode",array("buildings"=>"Geb&auml;ude","tech"=>"Technologien","ships"=>"Schiffe","defense"=>"Verteidigung"));
		echo "<br>";
			...
			while ($tarr=mysql_fetch_array($tres))
			{
				...
				if (ITEM_RACE_FLD!="")
				{
					...
					WHERE 
						...
						(
							".ITEM_RACE_FLD."=0 
							OR ".ITEM_RACE_FLD."=".$_SESSION[ROUNDID]['user']['race_id']."
						) 
