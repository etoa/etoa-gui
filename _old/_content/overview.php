<?PHP
	...
	*************/
		...
		WHERE
	    (alliance_news_alliance_id='".$_SESSION[ROUNDID]['user']['alliance_id']."'
	      OR alliance_news_alliance_to_id='".$_SESSION[ROUNDID]['user']['alliance_id']."'
	      OR alliance_news_public='1')
	    AND alliance_news_date>'".$_SESSION[ROUNDID]['user']['last_online']."'
		ORDER BY
	...
	************/
		...
		// Fremde Flotten
		//
		$num_friend=check_fleet_incomming_friendly($_SESSION[ROUNDID]['user']['id']); //Nicht feindliche Flotten
		$num=check_fleet_incomming($_SESSION[ROUNDID]['user']['id']); //Feindliche Flotten
		$all = $num + $num_friend;
	...
	******************/
	...
	$d_planets=$_SESSION[ROUNDID]['user']['planet_circle_width'];	//Durchmesser der Bilder (in Pixel)
	$d_infos=$_SESSION[ROUNDID]['user']['planet_circle_width'];		//Durchmesser der Infos (in Pixel)
