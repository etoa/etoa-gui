  		...
  		//
			...
			if (mysql_num_rows($sp_res)>0)
			{
				...
				while ($sp_arr=mysql_fetch_array($sp_res))
				{
                    ...
                    {
                        echo "<input type=\"text\" name=\"people_work[".$sp_arr['building_id']."]\" value=\"".$sp_arr['buildlist_people_working']."\" size=\"5\" maxlength=\"20\" onKeyPress=\"return nurZahlen(event)\"/>";
