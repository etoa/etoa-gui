<?PHP
	...
	//////////////////////////////////////////////////
	//
	// 	Dateiname: population.php
	// 	Topic: Bevölkerungsverwaltung
	// 	Autor: Nicolas Perrenoud alias MrCage
	// 	Erstellt: 01.12.2004
	// 	Bearbeitet von: Nicolas Perrenoud alias MrCage
	// 	Bearbeitet am: 13.05.2006
	// 	Kommentar:
	//
	...
	if ($planets->current)
	{
		...
		if (mysql_num_rows($res)>0)
		{
  		...
  		// Zählt alle arbeiter die eingetragen snid (besetzt oder nicht) für die anszeige!
			...
			{
	  		dbquery("UPDATE ".$db_table['buildlist']." SET buildlist_people_working='0' WHERE buildlist_user_id=".$_SESSION[ROUNDID]['user']['id']." AND  buildlist_people_working_status='dontwork' AND buildlist_planet_id=".$c->id."");
	  		$people_working=0;
			}
