<?PHP
	...
	if (mysql_num_rows($res)>0)
	{
		...
		while ($arr = mysql_fetch_array($res))
		{
			...
			echo "<a href=\"".IMAGE_PATH."/".IMAGE_PLANET_DIR."/planet".$arr['type_id']."_".$x.".gif\" rel=\"thumbnail\">";
			echo "<img src=\"".IMAGE_PATH."/".IMAGE_PLANET_DIR."/planet".$arr['type_id']."_".$x."_small.gif\" width=\"40\" height=\"40\" alt=\"planet\" border=\"0\"></a></td>";
