...
namespace planet
{
	...
	void PlanetManager::updateUserPlanets()
	{
		...
		mysqlpp::Query query = con_->query();
			query << "SELECT ";
			query << "	  planets.id, ";
			query << "	  planets.planet_user_main, ";
			query << "	  planets.planet_last_updated, ";
			query << "	  planets.planet_res_metal, ";
			query << "	  planets.planet_res_crystal, ";
			query << "	  planets.planet_res_plastic, ";
			query << "	  planets.planet_res_fuel, ";
			query << "	  planets.planet_res_food, ";
			query << "	  planets.planet_prod_metal, ";
			query << "	  planets.planet_prod_crystal, ";
			query << "	  planets.planet_prod_plastic, ";
			query << "	  planets.planet_prod_fuel, ";
			query << "	  planets.planet_prod_food, ";
			query << "	  planets.planet_store_metal, ";
			query << "	  planets.planet_store_crystal, ";
			query << "	  planets.planet_store_plastic, ";
			query << "	  planets.planet_store_fuel, ";
			query << "	  planets.planet_store_food, ";
