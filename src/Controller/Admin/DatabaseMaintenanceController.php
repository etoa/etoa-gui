...
class DatabaseMaintenanceController extends AbstractAdminController
{
    ...
    public function overview(Request $request): Response
    {
        ...
        return $this->render('admin/database/database.html.twig', [
            ...
            'bytesReceivedHour' => StringUtils::formatBytes($uth > 0 ? (int) ($st['bytes_received'] / $uth) : 0),
            'bytesSent' => StringUtils::formatBytes($st['bytes_sent']),
            'bytesSentHour' => StringUtils::formatBytes($uth > 0 ? (int) ($st['bytes_sent'] / $uth) : 0),
            ...
            'abortedConnectsHour' => StringUtils::formatNumber($uth > 0 ? (int) ($st['aborted_connects'] / $uth) : 0),
            'abortedClients' => StringUtils::formatNumber($st['aborted_clients']),
            'abortedClientsHour' => StringUtils::formatNumber($uth > 0 ? (int) (($st['aborted_clients']) / $uth) : 0),
            'connections' => StringUtils::formatNumber($st['connections']),
            'connectionsHour' => StringUtils::formatNumber($uth > 0 ? (int) ($st['connections'] / $uth) : 0),
            'questions' => StringUtils::formatNumber($st['questions']),
            'avgQuestionsDay' => StringUtils::formatNumber($uth > 0 ? (int) ($st['questions'] / $uth * 24) : 0),
            'avgQuestionsHour' => StringUtils::formatNumber($uth > 0 ? (int) ($st['questions'] / $uth) : 0),
            'avgQuestionsMinute' => StringUtils::formatNumber($utm > 0 ? (int) ($st['questions'] / $utm) : 0),
            'avgQuestionsSecond' => StringUtils::formatNumber($uts > 0 ? (int) ($st['questions'] / $uts) : 0),
