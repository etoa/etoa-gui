...
class AllianceUploadType extends AbstractType
{
    public function configureOptions(OptionsResolver $resolver): void
    {
        parent::configureOptions($resolver);
        $maxSize = AllianceImage::IMAGE_MAX_SIZE ?? 4194304;
        $maxWidth = AllianceImage::IMAGE_MAX_WIDTH;
        $maxHeight = AllianceImage::IMAGE_MAX_HEIGHT;
