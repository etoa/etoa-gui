...
#[ORM\Entity(repositoryClass: AllianceTechnologyRepository::class)]
#[ORM\Table(name: 'alliance_technologies')]
class AllianceTechnology implements ObjectWithImage
{
    #[ORM\Id]
    #[ORM\GeneratedValue(strategy: "AUTO")]
    #[ORM\Column(name: "alliance_tech_id")]
    private int $id;

    #[ORM\Column(name: "alliance_tech_name")]
    private string $name;

    #[ORM\Column(name: "alliance_tech_shortcomment")]
    private string $shortComment;

    #[ORM\Column(name: "alliance_tech_longcomment")]
    private string $longComment;

    #[ORM\Column(name: "alliance_tech_costs_metal")]
    private int $costsMetal;

    #[ORM\Column(name: "alliance_tech_costs_crystal")]
    private int $costsCrystal;

    #[ORM\Column(name: "alliance_tech_costs_plastic")]
    private int $costsPlastic;

    #[ORM\Column(name: "alliance_tech_costs_fuel")]
    private int $costsFuel;

    #[ORM\Column(name: "alliance_tech_costs_food")]
    ...
    #[ORM\Column(name: "alliance_tech_show")]
    private bool $show;

    #[ORM\Column(name: "alliance_tech_needed_id")]
    private int $neededId;

    #[ORM\Column(name: "alliance_tech_needed_level")]
