...
class Ship
{
    ...
    public function __construct(array $data)
    {
        ...
        $this->specialBonusWeapon = (float) $data['special_ship_bonus_weapon'];
        $this->specialBonusStructure = (float) $data['special_ship_bonus_structure'];
        $this->specialBonusShield = (float) $data['special_ship_bonus_shield'];
        $this->specialBonusHeal = (float) $data['special_ship_bonus_heal'];
        $this->specialBonusCapacity = (float) $data['special_ship_bonus_capacity'];
        $this->specialBonusSpeed = (float) $data['special_ship_bonus_speed'];
        $this->specialBonusPilots = (float) $data['special_ship_bonus_pilots'];
        $this->specialBonusTarn = (float) $data['special_ship_bonus_tarn'];
        $this->specialBonusAntrax = (float) $data['special_ship_bonus_antrax'];
        $this->specialBonusForsteal = (float) $data['special_ship_bonus_forsteal'];
        $this->specialBonusBuildDestroy = (float) $data['special_ship_bonus_build_destroy'];
        $this->specialBonusAntraxFood = (float) $data['special_ship_bonus_antrax_food'];
        $this->specialBonusDeactivate = (float) $data['special_ship_bonus_deactivade'];
        $this->specialBonusReadiness = (float) $data['special_ship_bonus_readiness'];
